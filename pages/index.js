  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.imagewrap}>
          ...
          <img className={styles.myImg} src="https://t3.ftcdn.net/jpg/03/86/83/28/360_F_386832865_KzXYSvOLzUhztbeVD5d6pi2MBMqwBGAL.jpg" width={237} height={158} alt="hunting coder" />
        </div>
        ...
        <div>
          ...
          <div>
            ...
            <p>JavaScript is the language used to design logic for the web. Lorem ipsum dolor sit ame</p>
